...
import { Plus, GripHorizontal, MoveVertical, Trash2, GripVertical } from 'lucide-react'
...
interface SectionRendererProps {
  ...
  handleDrop: (e: React.DragEvent, sectionId: string, columnIndex?: number) => void
  handleDragOver: (e: React.DragEvent, sectionId: string, columnIndex?: number) => void
  handleDragLeave: (e: React.DragEvent) => void
  handleResizeStart: (sectionId: string, dividerIndex: number, e: React.MouseEvent) => void
  handleSectionHeightResizeStart: (e: React.MouseEvent, sectionId: string) => void
